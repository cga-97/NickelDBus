...
# NDB sources
override SOURCES  += src/ndb/nickeldbus.cc src/ndb/NDBDbus.cc src/ndb/NDBCfmDlg.cc src/ndb/NDBWidgets.cc src/ndb/SageButtonMonitor.cc src/ndb/util.cc $(IFACE_DIR)/ndb_adapter.cpp
# NM sources
...
override MOCS 	  += src/ndb/NDBDbus.h src/ndb/NDBCfmDlg.h src/ndb/NDBWidgets.h src/ndb/SageButtonMonitor.h $(IFACE_DIR)/ndb_adapter.h
...
override KOBOROOT += script/sage-buttons-report.sh:/usr/bin/sage-buttons-report
override KOBOROOT += res/sage-buttons-fix-nm:/mnt/onboard/.adds/nm/sage-buttons-fix
